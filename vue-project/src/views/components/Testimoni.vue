<template>
    <section class="px-5 md:px-10 lg:px-20 xl:px-40 py-16 md:py-20 bg-white">
        <div class="text-center mb-12 md:mb-16">
            ...
            <h2 class="text-3xl mt-5 md:text-4xl lg:text-5xl font-bold text-gray-900 mb-3">
                Apa Kata Pelanggan
            </h2>
            <p class="text-gray-600 mt-5 text-base md:text-lg max-w-2xl mx-auto">
        ...
        <div class="relative">
            <div ref="sliderRef"
                ...
                <div v-for="testimonial in testimonials" :key="testimonial.id"
                    ...
                    <div
                        class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-6 md:p-8 h-full border border-gray-100">
                        ...
                        <div class="flex items-center gap-4 mt-auto">
                            <div
                                class="w-12 h-12 rounded-full bg-gradient-to-br from-[#2196F3] to-[#1976D2] flex items-center justify-center text-white font-bold text-lg flex-shrink-0">
            ...
            <div class="flex gap-3 justify-end mt-8">
                <button ref="prevBtn" @click="scrollPrev" :disabled="isAtStart"
                ...
                <button ref="nextBtn" @click="scrollNext" :disabled="isAtEnd"
                    class="w-12 h-12 rounded-full bg-[#2196F3] hover:bg-[#1976D2] disabled:bg-gray-300 disabled:cursor-not-allowed text-white flex items-center justify-center transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105 active:scale-95"
