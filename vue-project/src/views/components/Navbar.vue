        ...
        <transition name="slide-down">
            <div v-show="showNavbar"
                ...
                <div
                    ...
                    <span class="text-md group-hover:text-[#076bbe] font-semibold text-[#2196f3]">Hubungi Kami</span>
                </div>
                <!-- Mobile -->
                <div @click="isOpen" class="lg:hidden flex">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="size-6 text-[#2196f3] cursor-pointer">
